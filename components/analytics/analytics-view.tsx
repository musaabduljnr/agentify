      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 hover:shadow-md transition-all relative overflow-hidden group">
          ...
          <div className="text-xs text-slate-500 relative z-10 flex items-center gap-1.5 mt-2">
            <span className="font-semibold text-indigo-600">{stats.widgetConversations}</span> via Widget •{" "}
            <span className="font-semibold text-indigo-600">{stats.playgroundConversations}</span> Test
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 hover:shadow-md transition-all relative overflow-hidden group">
          ...
          <div className="text-xs text-slate-500 relative z-10 mt-2 flex items-center gap-1">
            ...
            <span className="font-bold text-emerald-600">Intent analysis</span> fully active for RAG triggers.
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm flex flex-col">
          <div className="mb-6">
            ...
            <p className="text-xs text-slate-500">
              Breakdown of chat sessions generated by the live widget vs playground.
            </p>
          </div>
